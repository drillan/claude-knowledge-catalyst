...
from claude_knowledge_catalyst.core.tag_standards import TagStandard, TagStandardsManager
...
class TestTagStandardsManager:
    ...
    def test_required_standards_present(self):
        ...
        required_standards = ["type", "status", "tech", "domain", "team", "complexity", "confidence"]
    ...
    def test_tech_standard_validation(self):
        ...
        expected_techs = ["python", "javascript", "typescript", "rust", "react", "vue", "docker"]
    ...
    def test_get_standard_existing(self):
        ...
        assert type_standard.name == "type"
        assert "prompt" in type_standard.valid_values  # Check it contains expected values
    ...
    def test_get_max_selections_existing_standard(self):
        ...
        assert tech_standard.max_selections is None or tech_standard.max_selections > 1  # Should allow multiple tech selections
    ...
    def test_get_required_standards(self):
        ...
        required = [name for name, standard in manager.standards.items() if standard.required]
