...
class TestFileClassification:
    ...
    def test_classify_file_intelligent_basic(self, mock_classifier_class, tmp_path):
        ...
        result = classify_file_intelligent(test_file, mock_config, mock_metadata_manager)
    ...
    def test_classify_file_intelligent_error_handling(self, tmp_path):
        ...
        result = classify_file_intelligent(nonexistent_file, mock_config, mock_metadata_manager)
    ...
    @patch("claude_knowledge_catalyst.cli.smart_sync.KnowledgeClassifier")
    def test_analyze_content_advanced_architecture(self, mock_classifier_class, tmp_path):
        ...
        result = analyze_content_advanced(arch_file.read_text(), arch_file, mock_classifier)
    ...
    def test_analyze_content_advanced_command(self, mock_classifier_class, tmp_path):
        ...
        result = analyze_content_advanced(cmd_file.read_text(), cmd_file, mock_classifier)
...
class TestSyncOperations:
    ...
    def test_run_ckc_sync_error_handling(self):
        ...
        with patch("claude_knowledge_catalyst.cli.smart_sync.console.print") as mock_print:
            result = run_ckc_sync()
...
class TestSmartSyncCommand:
    ...
    def test_smart_sync_command_basic(self, mock_console_print, mock_scan, tmp_path):
        ...
        with patch("claude_knowledge_catalyst.cli.smart_sync.run_ckc_sync") as mock_sync:
    ...
    def test_smart_sync_command_dry_run(self, tmp_path):
        ...
        with patch("claude_knowledge_catalyst.cli.smart_sync.console.print") as mock_print:
            with patch("claude_knowledge_catalyst.cli.smart_sync.scan_metadata_status") as mock_scan:
                mock_scan.return_value = ([], [])
                result = smart_sync_command(mock_config, directory=".claude", dry_run=True)
