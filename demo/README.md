# Claude Knowledge Catalyst v0.10.0 Demo Scripts

このディレクトリには、Claude Knowledge Catalyst (CKC) のYAKE統合および純粋タグ中心システムを実際に体験するためのデモスクリプトが含まれています。

> **🚀 v0.10.0 YAKE Integration Release**: 高度なキーワード抽出システムが統合され、147のテストすべてが通過する本番品質の安定性を実現しました。多言語対応（7言語）とAI強化分類が利用可能です。
...
- **🆕 YAKE統合**による教師なしキーワード抽出 (v0.10.0)
- **🆕 ハイブリッド分析**: 従来手法 + AI強化 (v0.10.0)
